...
namespace AC
{
	...
	public class ActionMusic : Action
	{
		...
		private int GetTrackIndex (MusicStorage[] musicStorages, bool showGUI = true)
		{
			int trackIndex = -1;
		...
		override public string SetLabel ()
		{
			...
			{
				int trackIndex = GetTrackIndex (AdvGame.GetReferences ().settingsManager.musicStorages.ToArray (), false);
				if (trackIndex >= 0)
				{
