...
namespace AC
{
	...
	public enum SpeechMenuType { All, CharactersOnly, NarrationOnly, SpecificCharactersOnly };
	...
	public enum DoubleClickingHotspot { MakesPlayerRun, TriggersInteractionInstantly };
