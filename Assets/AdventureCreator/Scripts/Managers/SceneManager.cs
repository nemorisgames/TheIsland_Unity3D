...
namespace AC
{
	...
	public class SceneManager : ScriptableObject
	{
		...
		public void ShowGUI ()
		{
			...
			{
				EditorGUILayout.BeginHorizontal ();
				KickStarter.sceneSettings.tintMap = (TintMap) EditorGUILayout.ObjectField ("Default Tint map:", KickStarter.sceneSettings.tintMap, typeof (TintMap), true);
			...
			GUILayout.BeginHorizontal ();
			GUILayout.Label ("Markers", buttonWidth);
			if (GUILayout.Button ("On", EditorStyles.miniButtonLeft))
			{
