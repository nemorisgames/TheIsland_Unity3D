...
namespace AC
{
	...
	public class ActiveList
	{
		 ...
		 */
		public bool LoadData (string dataString)
		{
			...
			if (convID != 0)
			{
				conversationOnEnd = Serializer.returnComponent <Conversation> (convID);
			}
			...
			{
				// Scene
				ConstantID constantID = Serializer.returnComponent <ConstantID> (ID);
